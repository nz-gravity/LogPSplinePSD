...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Multivariate PSD simulation study with VARMA data")
    parser.add_argument("--outdir", type=str, required=True, help="Output directory")
    parser.add_argument("--N", type=int, default=1024, help="Number of time points")
    parser.add_argument("--K", type=int, default=7, help="Number of spline knots")
