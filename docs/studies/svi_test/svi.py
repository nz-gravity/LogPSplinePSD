...
def run_svi(
    ...
    print("init weights dot P weights:", float(jnp.dot(weights_0, jnp.dot(spline_model.penalty_matrix, weights_0))))
    print("phi * wPw:", float(phi_0 * jnp.dot(weights_0, jnp.dot(spline_model.penalty_matrix, weights_0))))
