...
def power_whittle_log_likelihood(
    ...
    """Power/count likelihood copied from the WDM scalar surface model.
    ...
    This preserves the source's unclipped likelihood and omits data-only
    constants. The stationary Fourier entry point below keeps its existing
    clipping, ENBW and tempering conventions.
    """
